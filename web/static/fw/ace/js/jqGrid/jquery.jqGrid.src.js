...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		for(i=0;i<this.p.colNames.length;i++){
			...
			var theadclass = ts.p.colModel[i].thclasses;
			theadclass = theadclass ? theadclass + " " : ""; 
			thead += "<th id='"+ts.p.id+"_"+ts.p.colModel[i].name+"' role='columnheader' class='" + theadclass + "ui-state-default ui-th-column ui-th-"+dir+"'"+ tooltip+">";
