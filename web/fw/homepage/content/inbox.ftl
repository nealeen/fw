		...
		<div class="hide message-content" id="id-message-content">
			...
			<div class="message-header clearfix">
				<div class="pull-left">
					...
					&nbsp;
					<img class="middle" alt="John's Avatar" src="${request.contextPath}/static/ace/avatars/avatar.png" width="32" />
					&nbsp;
			...
			<div class="message-attachment clearfix">
				...
				<div class="attachment-images pull-right">
					...
					<div>
						<img width="36" alt="image 4" src="${request.contextPath}/static/ace/images/gallery/thumb-4.jpg" />
						<img width="36" alt="image 3" src="${request.contextPath}/static/ace/images/gallery/thumb-3.jpg" />
						<img width="36" alt="image 2" src="${request.contextPath}/static/ace/images/gallery/thumb-2.jpg" />
						<img width="36" alt="image 1" src="${request.contextPath}/static/ace/images/gallery/thumb-1.jpg" />
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	var scripts = [null,"${request.contextPath}/static/ace/js/bootstrap-tag.js","${request.contextPath}/static/ace/js/jquery.hotkeys.js","${request.contextPath}/static/ace/js/bootstrap-wysiwyg.js", null]
