		...
		<div class="row">
			<div class="col-xs-3">
				<a href="../../build/demo/email-confirmation.html" class="thumbnail" target="_blank">
					<img class="img-responsive" src="${request.contextPath}/static/ace/images/email1.png" alt="Email Template" />
				</a>
			</div>

			<div class="col-xs-3">
				<a href="../../build/demo/email-navbar.html" class="thumbnail" target="_blank">
					<img class="img-responsive" src="${request.contextPath}/static/ace/images/email2.png" alt="Email Template" />
				</a>
			</div>

			<div class="col-xs-3">
				<a href="../../build/demo/email-newsletter.html" class="thumbnail" target="_blank">
					<img class="img-responsive" src="${request.contextPath}/static/ace/images/email3.png" alt="Email Template" />
				</a>
			</div>

			<div class="col-xs-3">
				<a href="../../build/demo/email-contrast.html" class="thumbnail" target="_blank">
					<img class="img-responsive" src="${request.contextPath}/static/ace/images/email4.png" alt="Email Template" />
				</a>
			</div>
		</div>
