...
<div class="row">
	<div class="col-xs-12">
		...
		<script type="text/javascript">
			var $path_assets = "${request.contextPath}/static/ace";//this will be used in gritter alerts containing images
		</script>
		...
		*/
		...
		$('#gritter-regular').on(ace.click_event, function(){
			$.gritter.add({
				...
				image: '${request.contextPath}/static/ace/avatars/avatar1.png', //in Ace demo ${request.contextPath}/static/ace will be replaced by correct assets path
				sticky: false,
				time: '',
		...
		$('#gritter-sticky').on(ace.click_event, function(){
			var unique_id = $.gritter.add({
				...
				image: '${request.contextPath}/static/ace/avatars/avatar.png',
				sticky: true,
				time: '',
		...
		$('#gritter-max3').on(ace.click_event, function(){
			$.gritter.add({
				...
				image: '${request.contextPath}/static/ace/avatars/avatar3.png', //in Ace demo ${request.contextPath}/static/ace will be replaced by correct assets path
				sticky: false,
