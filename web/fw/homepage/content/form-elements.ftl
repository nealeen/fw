...
<link rel="stylesheet" href="${request.contextPath}/static/ace/css/chosen.css" />
<link rel="stylesheet" href="${request.contextPath}/static/ace/css/datepicker.css" />
<link rel="stylesheet" href="${request.contextPath}/static/ace/css/bootstrap-timepicker.css" />
<link rel="stylesheet" href="${request.contextPath}/static/ace/css/daterangepicker.css" />
<link rel="stylesheet" href="${request.contextPath}/static/ace/css/bootstrap-datetimepicker.css" />
<link rel="stylesheet" href="${request.contextPath}/static/ace/css/colorpicker.css" />
...
<script type="text/javascript">
	var scripts = [null,"${request.contextPath}/static/ace/js/jquery-ui.custom.js","${request.contextPath}/static/ace/js/jquery.ui.touch-punch.js","${request.contextPath}/static/ace/js/chosen.jquery.js","${request.contextPath}/static/ace/js/fuelux/fuelux.spinner.js","${request.contextPath}/static/ace/js/date-time/bootstrap-datepicker.js","${request.contextPath}/static/ace/js/date-time/bootstrap-timepicker.js","${request.contextPath}/static/ace/js/date-time/moment.js","${request.contextPath}/static/ace/js/date-time/daterangepicker.js","${request.contextPath}/static/ace/js/date-time/bootstrap-datetimepicker.js","${request.contextPath}/static/ace/js/bootstrap-colorpicker.js","${request.contextPath}/static/ace/js/jquery.knob.js","${request.contextPath}/static/ace/js/jquery.autosize.js","${request.contextPath}/static/ace/js/jquery.inputlimiter.1.3.1.js","${request.contextPath}/static/ace/js/jquery.maskedinput.js","${request.contextPath}/static/ace/js/bootstrap-tag.js", null]
