...
<script type="text/javascript">
	var scripts = [null,"${request.contextPath}/static/ace/js/fuelux/fuelux.wizard.js","${request.contextPath}/static/ace/js/jquery.validate.js","${request.contextPath}/static/ace/js/additional-methods.js","${request.contextPath}/static/ace/js/bootbox.js","${request.contextPath}/static/ace/js/jquery.maskedinput.js","${request.contextPath}/static/ace/js/select2.js", null]
