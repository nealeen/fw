...
<script type="text/javascript">
	var scripts = [null,"${resourceUrl}/ace/js/fuelux/fuelux.wizard.js","${resourceUrl}/ace/js/jquery.validate.js","${resourceUrl}/ace/js/additional-methods.js","${resourceUrl}/ace/js/bootbox.js","${resourceUrl}/ace/js/jquery.maskedinput.js","${resourceUrl}/ace/js/select2.js", null]
