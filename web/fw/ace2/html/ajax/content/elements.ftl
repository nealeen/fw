...
<div class="row">
	<div class="col-xs-12">
		...
		<script type="text/javascript">
			var $path_assets = "${resourceUrl}/ace";//this will be used in gritter alerts containing images
		</script>
...
<![endif]-->
<script type="text/javascript">
	var scripts = [null,"${resourceUrl}/ace/js/jquery-ui.custom.js","${resourceUrl}/ace/js/jquery.ui.touch-punch.js","${resourceUrl}/ace/js/bootbox.js","${resourceUrl}/ace/js/jquery.easypiechart.js","${resourceUrl}/ace/js/jquery.gritter.js","${resourceUrl}/ace/js/spin.js", null]
		...
		*/
		...
		$('#gritter-regular').on(ace.click_event, function(){
			$.gritter.add({
				...
				image: '${resourceUrl}/ace/avatars/avatar1.png', //in Ace demo ${resourceUrl}/ace will be replaced by correct assets path
				sticky: false,
				time: '',
		...
		$('#gritter-sticky').on(ace.click_event, function(){
			var unique_id = $.gritter.add({
				...
				image: '${resourceUrl}/ace/avatars/avatar.png',
				sticky: true,
				time: '',
		...
		$('#gritter-max3').on(ace.click_event, function(){
			$.gritter.add({
				...
				image: '${resourceUrl}/ace/avatars/avatar3.png', //in Ace demo ${resourceUrl}/ace will be replaced by correct assets path
				sticky: false,
