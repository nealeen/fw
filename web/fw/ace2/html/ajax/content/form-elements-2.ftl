...
<link rel="stylesheet" href="${resourceUrl}/ace/css/bootstrap-duallistbox.css" />
<link rel="stylesheet" href="${resourceUrl}/ace/css/bootstrap-multiselect.css" />
...
<script type="text/javascript">
	var scripts = [null,"${resourceUrl}/ace/js/jquery.bootstrap-duallistbox.js","${resourceUrl}/ace/js/jquery.raty.js","${resourceUrl}/ace/js/bootstrap-multiselect.js","${resourceUrl}/ace/js/select2.js","${resourceUrl}/ace/js/typeahead.jquery.js", null]
