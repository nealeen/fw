...
<link rel="stylesheet" href="${resourceUrl}/ace/css/chosen.css" />
<link rel="stylesheet" href="${resourceUrl}/ace/css/datepicker.css" />
<link rel="stylesheet" href="${resourceUrl}/ace/css/bootstrap-timepicker.css" />
<link rel="stylesheet" href="${resourceUrl}/ace/css/daterangepicker.css" />
<link rel="stylesheet" href="${resourceUrl}/ace/css/bootstrap-datetimepicker.css" />
<link rel="stylesheet" href="${resourceUrl}/ace/css/colorpicker.css" />
...
<script type="text/javascript">
	var scripts = [null,"${resourceUrl}/ace/js/jquery-ui.custom.js","${resourceUrl}/ace/js/jquery.ui.touch-punch.js","${resourceUrl}/ace/js/chosen.jquery.js","${resourceUrl}/ace/js/fuelux/fuelux.spinner.js","${resourceUrl}/ace/js/date-time/bootstrap-datepicker.js","${resourceUrl}/ace/js/date-time/bootstrap-timepicker.js","${resourceUrl}/ace/js/date-time/moment.js","${resourceUrl}/ace/js/date-time/daterangepicker.js","${resourceUrl}/ace/js/date-time/bootstrap-datetimepicker.js","${resourceUrl}/ace/js/bootstrap-colorpicker.js","${resourceUrl}/ace/js/jquery.knob.js","${resourceUrl}/ace/js/jquery.autosize.js","${resourceUrl}/ace/js/jquery.inputlimiter.1.3.1.js","${resourceUrl}/ace/js/jquery.maskedinput.js","${resourceUrl}/ace/js/bootstrap-tag.js", null]
